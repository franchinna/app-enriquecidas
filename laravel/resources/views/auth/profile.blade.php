        ...
        <div class="row gap-2">
            ...
            <div class="col-12 col-lg-4 p-lg-0">
                <div class="rounded border p-4 profile-box">
                    ...
                    <a href="{{ route('users.editForm', ['user' => auth()->user()->id]) }}" 
                        type="button" title="Edit" class="btn btn-sm btn-light">
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button type="button" title="Confirm order" class="btn btn-sm btn-info rounded">Detail</button>
                                  </div>
                            </td>
                          </tr>
                          @endforeach
